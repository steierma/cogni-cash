...
export default function ReconcilePage() {
    ...
    return (
        <div className="max-w-6xl mx-auto animate-in fade-in duration-300 pb-20">
            ...
            {successMessage && (
                <div className="mb-6 flex items-center gap-3 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 rounded-xl text-green-700 dark:text-green-400">
                    ...
                    <div className="bg-white dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm flex flex-col md:flex-row gap-4 items-end">
                        ...
                        <div className="flex items-end gap-2 w-full md:w-auto">
                            <button
                                ...
                                title={t('reconcile.manual.prevPeriod', 'Previous Period')}
                            >
                                <ChevronLeft size={18} />
                            </button>
                            ...
                            <button
                                onClick={() => shiftDateRange(1)}
                                className="mb-[2px] p-2 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-500 hover:text-indigo-600 hover:border-indigo-300 transition-colors"
                                title={t('reconcile.manual.nextPeriod', 'Next Period')}
                            >
                        ...
                        >
                            <Filter size={16} /> {t('common.filter', 'Apply Filter')}
                        </button>
                    </div>
