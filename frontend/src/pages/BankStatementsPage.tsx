                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            <button
                                                ...
                                                title={stmt.has_original_file ? t('bankStatements.actions.preview', 'Preview') : t('bankStatements.actions.previewUnavailable', 'Preview not available (file was not stored)')}
                                            >
                                            ...
                                            <button
                                                ...
                                                title={stmt.has_original_file ? t('bankStatements.actions.download') : t('bankStatements.actions.downloadUnavailable', 'Download not available (file was not stored)')}
                                            >
                                                <Download size={18} />
                                            </button>
                                            <button
