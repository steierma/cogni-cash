...
import { KeyRound, CheckCircle2, AlertCircle, Settings, Server, Database, Save, Palette, Globe, ChevronDown, ChevronRight, MessageSquareCode, Landmark, Info } from 'lucide-react';
                ...
                <form onSubmit={handleSettingsSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{t('settings.examplesPerCategory')}</label>
                                <p className="text-[10px] text-gray-500 dark:text-gray-400 mb-1">{t('settings.examplesPerCategoryDesc')}</p>
                                <input
                                    type="number"
                                    min="0"
                                    max="100"
                            ...
                            <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100 border-b dark:border-gray-800 pb-2 mt-6 pt-4">{t('settings.bankIntegration') || "Bank Integration"}</h3>

                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 flex items-center gap-2">
                                    <Landmark size={16} className="text-gray-400"/> {t('settings.bankProvider') || "Bank Provider"}
                                </label>
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-300"
                                >
                                    <option value="gocardless">GoCardless (Nordigen)</option>
                                    <option value="enablebanking">Enable Banking</option>
                                </select>
                            </div>

                            {settingsParams['bank_provider'] === 'gocardless' && (
                                <div className="space-y-4 animate-in slide-in-from-top-2 duration-200">
                                    <div className="p-3 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800/50 rounded-xl flex items-start gap-2 text-xs text-indigo-700 dark:text-indigo-300">
                                        ...
                                        <p>
                                            {t('settings.gocardlessInfo') || "Obtain your Secret ID and Secret Key from the GoCardless (formerly Nordigen) dashboard under 'Bank Account Data' > 'User Secrets'."}
                                        </p>
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            type="text"
                                            value={settingsParams['gocardless_secret_id'] || ''}
                                            onChange={(e) => handleSettingChange('gocardless_secret_id', e.target.value)}
                                            className="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-300 font-mono"
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            type="password"
                                            value={settingsParams['gocardless_secret_key'] || ''}
                                            onChange={(e) => handleSettingChange('gocardless_secret_key', e.target.value)}
                                            className="w-full px-4 py-2.5 text-sm rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-indigo-300"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="space-y-4 animate-in slide-in-from-top-2 duration-200">
                                    <div className="p-3 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800/50 rounded-xl flex items-start gap-2 text-xs text-indigo-700 dark:text-indigo-300">
                                        ...
                                        <div className="space-y-1 text-[11px] sm:text-xs">
                                            <p>
                                                {t('settings.enablebankingInfo') || "Register your application at EnableBanking.com to get your App ID."}
                                            </p>
                                            <p className="font-semibold mt-1">
                                                {t('settings.enablebankingKeyInfo') || "Security Notice: The RSA Private Key must be provided via the ENABLEBANKING_PRIVATE_KEY_PATH environment variable (or as a string via ENABLEBANKING_PRIVATE_KEY) and cannot be edited here."}
                                            </p>
                                        </div>
                                    </div>
                                    <div>
