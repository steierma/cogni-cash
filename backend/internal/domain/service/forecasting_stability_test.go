...
func TestForecastingService_ExclusionStability(t *testing.T) {
	...
	txns := []entity.Transaction{
		{UserID: userID, Description: "Rent", Amount: -1000.0, BaseAmount: -1000.0, BookingDate: now.AddDate(0, -3, 0), ContentHash: "rent-jan"},
		{UserID: userID, Description: "Rent", Amount: -1000.0, BaseAmount: -1000.0, BookingDate: now.AddDate(0, -2, 0), ContentHash: "rent-feb"},
		{ID: marID, UserID: userID, Description: "Rent", Amount: -1000.0, BaseAmount: -1000.0, BookingDate: now.AddDate(0, -1, 0), ContentHash: "rent-mar"},
	}
	...
	txns = append(txns, entity.Transaction{
		ID: aprID, UserID: userID, Description: "Rent", Amount: -1000.0, BaseAmount: -1000.0, BookingDate: now, ContentHash: "rent-apr",
	})
