...
db-truncate:
	@echo ">>> Truncating all tables on $(DB_HOST)…"
	$(PSQL) -c "TRUNCATE TABLE payslip_bonuses, payslips, settings, reconciliations, transactions, bank_statements, invoices, categories, users RESTART IDENTITY CASCADE;"
	@echo ">>> Done."
