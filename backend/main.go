...
func main() {
	...
	// The list is refreshed via WithCategories if needed; a nil slice is safe.
	...
	// --- HTTP Handler Setup ---
	handler := httpAdapter.NewHandler(authSvc, invoiceSvc, bankStatementSvc, settingsSvc, logger, storageMode, dbHost, dbPinger)
