    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 pb-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                        <Briefcase className="text-indigo-600 dark:text-indigo-400"/> Payslips</h1>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your HR documents and track your
                        true net income.</p>
                </div>
            </div>
                ...
                >
                    ...
                    <div>
                        {uploadMutation.isPending ?
                            <p className="text-sm font-medium text-gray-900 dark:text-gray-100 animate-pulse">Uploading
                                & Parsing...</p> : <><p
                                className="text-sm font-medium text-gray-900 dark:text-gray-100"><span
                                className="text-indigo-600 dark:text-indigo-400">Click to auto-parse</span> or drag and
                                drop</p><p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Accepts standard
                                PDF formats</p></>}
                    </div>
                </div>
            ...
            {uploadMutation.isError && <div
                className="p-4 bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-400 rounded-xl border border-red-200 dark:border-red-800/50 text-sm">Failed
                to upload payslip. Ensure it's a valid PDF and hasn't been uploaded already.</div>}
            ...
            <div
                ...
                <div className="flex flex-wrap items-center gap-4">
                    <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400"><Filter size={18}/><span
                        className="text-sm font-medium">Filters:</span></div>
                    ...
                    <select value={selectedTaxClass} onChange={e => setSelectedTaxClass(e.target.value)}
                        ...
                        {uniqueTaxClasses.map(t => <option key={t} value={t}>Class {t}</option>)}</select>
                    <button onClick={handleApplyFilters}
                            className="px-4 py-1.5 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 text-sm font-medium rounded-lg hover:bg-gray-800 dark:hover:bg-gray-200 transition-colors">Apply
                        Filters
                    </button>
                </div>
                <div className="relative">
                    ...
                    {showColMenu && (
                        <div
                            ...
                            {[{key: 'period', label: 'Period'}, {key: 'employee', label: 'Employee'}, {
                                key: 'gross',
                                label: 'Gross (Brutto)'
                            }, {key: 'net', label: 'Total Net (Netto)'}, {
                                key: 'adjNet',
                                label: 'Adjusted Net'
                            }, {key: 'payout', label: 'Payout'}, {key: 'leasing', label: 'Leasing Rate'}].map(({
                                                                                                                   key,
                                                                                                                   label
                                                                                                               }) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1">Latest
                                Total Net</p>
                    ...
                    <div
                        ...
                        <div className="flex-1">
                            <p className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wide mb-1">Adjusted
                                Net</p>
                            <div className="flex items-end gap-2">
                            ...
                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Month-over-month growth</p>
                        </div>
                    </div>
                    <div
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">Tax
                                Class {latestPayslip.tax_class}</p>
                        </div>
                    </div>
                </div>
            )}
