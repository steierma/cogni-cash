                                    ...
                                    <ResponsiveContainer width="100%" height="100%">
                                        <BarChart data={trendData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                            ...
                                            <RechartsTooltip
                                                ...
                                                formatter={(value: any) => [fmtCurrency(Number(value) || 0, 'EUR'), '']}
                                            />
                                            <Bar dataKey="netIncome" stackId="hr" fill="#10b981" name="Net Income (HR)" radius={[0, 0, 4, 4]} barSize={40} />
                                            <Bar dataKey="deductions" stackId="hr" fill="#fbbf24" name="Taxes/Deductions" radius={[4, 4, 0, 0]} />
                                            <Bar dataKey="expense" fill="#f43f5e" name="Bank Expenses" radius={[4, 4, 0, 0]} barSize={40} />
                                        </BarChart>
                                    </ResponsiveContainer>
                                ) : (
