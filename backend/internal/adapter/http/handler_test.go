...
func TestHealthCheck(t *testing.T) {
	...
	handler := apphttp.NewHandler(nil, nil, nil, nil, setupLogger(), "memory", "localhost", dummyPinger)
	r := chi.NewRouter()
...
func TestChangePassword(t *testing.T) {
	...
	dummyPinger := func(ctx context.Context) error { return nil }
	handler := apphttp.NewHandler(authSvc, nil, nil, nil, setupLogger(), "memory", "localhost", dummyPinger)
...
func TestGetTransactionAnalytics(t *testing.T) {
	...
	txSvc := service.NewTransactionService(repo, nil, nil, setupLogger())
...
func TestListCategories_Empty(t *testing.T) {
	...
	dummyPinger := func(ctx context.Context) error { return nil }
	handler := apphttp.NewHandler(authSvc, nil, nil, nil, setupLogger(), "memory", "localhost", dummyPinger).WithCategoryRepository(mockRepo)
...
func TestDeleteBankStatement(t *testing.T) {
	...
	dummyPinger := func(ctx context.Context) error { return nil }
	handler := apphttp.NewHandler(authSvc, nil, svc, nil, setupLogger(), "memory", "localhost", dummyPinger).
