...
import {
    ...
    LayoutDashboard, Link2, LogOut, Menu, Monitor, Moon, Settings, Sparkles, Sun, Tag, Users, X
} from 'lucide-react';
...
const ALL_NAV_GROUPS = [
    ...
    },
    {
        ...
        items: [
            {to: '/bank-statements', i18nKeyLabel: 'layout.statements', Icon: Landmark},
    ...
    },
    {
        ...
        items: [
            ...
            {to: '/categorize', i18nKeyLabel: 'layout.categorize', Icon: Sparkles},
        ]
    },
    {
...
export default function Layout({children}: { children?: React.ReactNode }) {
    ...
    useEffect(() => {
        if (settings?.sidebar_expanded !== undefined) {
            setIsDesktopExpanded(settings.sidebar_expanded === 'true');
        }
    }, [settings?.sidebar_expanded]);
