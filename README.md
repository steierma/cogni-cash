...
* **🔮 Predictive Intelligence:** Look into your financial future with the **Forecasting Engine**.
 Automatically detects recurring patterns up to yearly intervals with a fixed 3-year historical lookback. Calculates a **Monthly Burn Rate** for variable categories and projects **Seasonal Bonuses**. Includes **Forecast Fine-Tuning** to mute or exclude specific projections.
...
* **🗄️ Unified Document Vault:** A centralized, encrypted repository for all your tax certificates, receipts, contracts, and other financial documents. Features **OCR-powered full-text search** and a dedicated **Tax Year View**. Supports manual and AI-assisted uploads.
